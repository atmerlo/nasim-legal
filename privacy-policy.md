...
**[APPNAME]** ("the app", "we") is a daily Islamic spiritual practice app. This policy explains what we collect, why, and what we will never do. It is written to be read, not skimmed.
...
- If you are in the EU, UK, or a jurisdiction with similar rights, the export and delete tools above satisfy access and erasure requests. For anything else, email the address below.
